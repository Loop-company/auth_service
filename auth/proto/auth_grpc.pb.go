...
const (
	...
	AuthService_GetProfileGUID_FullMethodName = "/auth.AuthService/GetProfileGUID"
...
func (c *authServiceClient) GetProfileGUID(ctx context.Context, in *GetProfileGUIDRequest, opts ...grpc.CallOption) (*GetProfileGUIDResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetProfileGUIDResponse)
	err := c.cc.Invoke(ctx, AuthService_GetProfileGUID_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedAuthServiceServer) GetProfileGUID(context.Context, *GetProfileGUIDRequest) (*GetProfileGUIDResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetProfileGUID not implemented")
}
...
func _AuthService_GetProfileGUID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetProfileGUIDRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthServiceServer).GetProfileGUID(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AuthService_GetProfileGUID_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).GetProfileGUID(ctx, req.(*GetProfileGUIDRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AuthService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetProfileGUID",
			Handler:    _AuthService_GetProfileGUID_Handler,
		},
		{
